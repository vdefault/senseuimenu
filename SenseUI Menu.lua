...
function draw_callback()
	if SenseUI.BeginWindow( "wnd1", 50, 50, 620, 600) then
		...
		SenseUI.SetWindowDrawTexture( true ); -- Makes huge fps drop. Not recommended to use yet
		...
		if SenseUI.BeginTab( "gunsettings", SenseUI.Icons.legit ) then
			if SenseUI.BeginGroup( "gunssettingss", "Main", 25, 25, 235, 490 ) then
		...
		if SenseUI.BeginTab( "vissettings", SenseUI.Icons.visuals ) then
			if SenseUI.BeginGroup( "Work In Progress", "Work In Progress", 25, 25, 235, 110 ) then
				SenseUI.Label("Work In Progress", true);
				SenseUI.Label("It possible", true);
				SenseUI.Label("Release 4-12 February 2019", true);
				SenseUI.Label("Who want to help me pm in discord", true);
				SenseUI.Label("Ill add you in credits if you help me :3", true);
			end
			SenseUI.EndGroup();
		end
		SenseUI.EndTab();
		if SenseUI.BeginTab( "miscsettings", SenseUI.Icons.settings ) then
			...
			SenseUI.EndGroup();
			if SenseUI.BeginGroup( "misc", "Miscellaneous", 25, 25, 235, 470 ) then
