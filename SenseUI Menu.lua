...
function draw_callback()
	if SenseUI.BeginWindow( "wnd1", 50, 50, 620, 670) then
		...
		if SenseUI.BeginTab( "aimbot", SenseUI.Icons.rage ) then
			if SenseUI.BeginGroup( "mainaim", "Aimbot", 25, 25, 235, 280 ) then
			...
			if SenseUI.BeginGroup( "otheraim", "Other", 285, 25, 235, 195 ) then
				...
				nospread = SenseUI.Checkbox("Remove spread", nospread);
